import {
  ...
  useForceUpdate,
  useNavItem
} from "./chunk-6R7C77WX.js";
import {
  Row_default
} from "./chunk-6TAJCHC5.js";
import {
  Badge_default
} from "./chunk-JA5PMIAH.js";
import {
  AlertHeading_default,
  AlertLink_default,
  Alert_default
} from "./chunk-JPCR2QOI.js";
import {
  Anchor_default,
  useCallbackRef,
  useEventListener
} from "./chunk-RNCZGT7S.js";
import {
  CardBody_default,
  CardFooter_default,
  CardHeader_default,
...
function map(children, func) {
  let index = 0;
  return React16.Children.map(children, (child) => React16.isValidElement(child) ? func(child, index++) : child);
}
function forEach(children, func) {
  let index = 0;
  React16.Children.forEach(children, (child) => {
    if (React16.isValidElement(child)) func(child, index++);
  });
}
function hasChildOfType(children, type) {
  return React16.Children.toArray(children).some((child) => React16.isValidElement(child) && child.type === type);
}
...
var FormControl = React42.forwardRef(({
  ...
  return (0, import_jsx_runtime42.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames30.default)(className, plaintext ? `${bsPrefix}-plaintext` : bsPrefix, size2 && `${bsPrefix}-${size2}`, type === "color" && `${bsPrefix}-color`, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormLabel = React45.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column) return (0, import_jsx_runtime45.jsx)(Col_default, {
    ref,
    as: "label",
    className: classes,
    htmlFor,
  ...
  return (
    ...
    (0, import_jsx_runtime45.jsx)(Component2, {
      ref,
      className: classes,
      htmlFor,
      ...props
...
var Switch = React49.forwardRef((props, ref) => (0, import_jsx_runtime49.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Modal = React61.forwardRef(({
  ...
  const renderBackdrop = (0, import_react31.useCallback)((backdropProps) => (0, import_jsx_runtime62.jsx)("div", {
    ...backdropProps,
...
var NavDropdown = React62.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime74.jsxs)(import_jsx_runtime73.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react36.cloneElement)(children, triggerProps), (0, import_jsx_runtime72.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var ToastFade = React87.forwardRef((props, ref) => (0, import_jsx_runtime94.jsx)(Fade_default, {
  ...props,
  ref,
